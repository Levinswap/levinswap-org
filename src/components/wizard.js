...
const links = [
    ...
    sublinks: [
      {
        ...
        description: 'Simplify the process of integrating Levinswap into your project.',
        tag: 'reference',
        icon: '📦'
      },
      {
        ...
        description: 'A step-by-step guide to getting started building interfaces with Levinswap.',
        tag: 'tutorial',
        icon: '🧼'
      },

      {
        ...
        description: 'Withdraw the reserves of any ERC20 token on Levinswap and execute arbitrary logic.',
        tag: 'guide',
        icon: '⚡'
      },
      {
  ...
  },
  {
    ...
    sublinks: [
      {
        title: 'Anatomy of a Levinswap Pool',
        link: '/docs/v2/pools',
        description: 'An overview of what a Levinswap liquidity pool.'
      },
      {
    ...
    sublinks: [
      {
        ...
        description: 'A high level technical overview of the Levinswap protocol.'
      }
    ]
  }
]
